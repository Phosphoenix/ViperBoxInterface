...
# defaults.py
$fileUrl = "https://raw.githubusercontent.com/sbalk/viperboxinterface/main/defaults/defaults.py"
$fileDestination = Join-Path -Path $mainFolderPath -ChildPath "defaults/defaults.py"
Invoke-WebRequest -Uri $fileUrl -OutFile $fileDestination

# update.ps1
$fileUrl = "https://raw.githubusercontent.com/sbalk/viperboxinterface/main/setup/update.ps1"
$fileDestination = Join-Path -Path $mainFolderPath -ChildPath "setup/update.ps1"
Invoke-WebRequest -Uri $fileUrl -OutFile $fileDestination

# viperbox.yaml
$fileUrl = "https://raw.githubusercontent.com/sbalk/viperboxinterface/main/setup/viperbox.yaml"
